...
Public Class ErrorTextHelper
    Private Shared Function NewLinesToBr(ByVal text As String) As String
        text = text.Replace(ControlChars.Cr, String.Empty)
        Return text.Replace(ControlChars.Lf, "<br/>")
    End Function
    Public Shared Function PrepareMessage(ByVal subjectText As String, ByVal detailInfoText As String, ByVal showDetailedErrorInfo As Boolean) As String
        Dim subject As String = String.Format("{0}" & ControlChars.Lf, subjectText)
        Dim detailInfo As String = String.Format("Detailed information is included below." & ControlChars.Lf & ControlChars.Lf & "- {0}", detailInfoText)
